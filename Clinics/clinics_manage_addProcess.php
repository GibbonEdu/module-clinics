...
$URL = $gibbon->session->get('absoluteURL').'/index.php?q=/modules/Clinics/clinics_manage_add.php&gibbonSchoolYearID='.$gibbonSchoolYearID.'&clinicsBlockID='.$clinicsBlockID;
...
if (isActionAccessible($guid, $connection2, '/modules/Clinics/clinics_manage_add.php') == false) {
    ...
    // Create the record
    $clinicsClinicID = $clinicsGateway->insert($data);
